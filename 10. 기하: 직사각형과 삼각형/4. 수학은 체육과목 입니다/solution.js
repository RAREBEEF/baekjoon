...
// 이미지 여부: true
//
// 원본 이미지 0: https://upload.acmicpc.net/8f346caa-48f9-4e98-afcd-1aedbce594f4/-/preview/
//
// 원본 이미지 1: https://upload.acmicpc.net/5b7d2e93-e324-40c8-a274-0104750d6c43/-/preview/

const input = parseInt(require("fs").readFileSync("./input1.txt"));

const solution = (n) => n * 4;
