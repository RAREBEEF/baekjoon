...
// 오영식 : 내가 지다니 분하다. ㅜㅜ
//
// 오박사 : 그럼 다솜아 이제 진정한 포켓몬 마스터가 되기 위해 도감을 완성시키도록 하여라. 일단 네가 현재 가지고 있는 포켓몬 도감에서 포켓몬의 이름을 보면 ��켓몬의 번호를 말하거나, 포켓몬의 번호를 보면 포켓몬의 이름을 말하는 연습을 하도록 하여라. 나의 시험을 통과하면, 내가 새로 만든 도감을 주도록 하겠네.
//
// input:
//
...
// 이미지 여부: true
//
// 원본 이미지 0: https://www.acmicpc.net//upload/201004/p1.PNG
//
// 원본 이미지 1: https://www.acmicpc.net//upload/201004/p2.PNG
//
// 원본 이미지 2: https://www.acmicpc.net//upload/201004/p3.PNG
//
// 원본 이미지 3: https://www.acmicpc.net//upload/201004/p4.PNG
//
// 원본 이미지 4: https://www.acmicpc.net//upload/201004/p5.PNG
//
// 원본 이미지 5: https://www.acmicpc.net//upload/201004/p6.PNG
//
// 원본 이미지 6: https://www.acmicpc.net//upload/201004/p7.PNG
//
// 원본 이미지 7: https://www.acmicpc.net//upload/201004/p8.PNG
//
// 원본 이미지 8: https://www.acmicpc.net//upload/201004/p9.PNG
//
// 원본 이미지 9: https://www.acmicpc.net//upload/201004/pa.PNG
//
// 원본 이미지 10: https://www.acmicpc.net//upload/201004/pb.PNG
//
// 원본 이미지 11: https://www.acmicpc.net//upload/201004/pc.PNG
//
// 원본 이미지 12: https://www.acmicpc.net//upload/201004/pd.PNG
//
// 원본 이미지 13: https://www.acmicpc.net//upload/201004/pe.PNG
//
// 원본 이미지 14: https://www.acmicpc.net//upload/201004/pf.PNG
//
// 원본 이미지 15: https://www.acmicpc.net//upload/201004/pg.PNG
//
// 원본 이미지 16: https://www.acmicpc.net//upload/201004/ph.PNG
//
// 원본 이미지 17: https://www.acmicpc.net//upload/201004/pi.PNG
...
const solution = (pokemons) => {
  const [pokemonCount, problemCount] = pokemons
      .shift()
      .split(" ")
      .map((str) => parseInt(str)),
    problems = pokemons.splice(pokemonCount),
    pokemonMap = new Map(),
    pokemonReverseMap = new Map(),
    result = [];

  for (let i = 1; i <= pokemonCount; i++) {
    const pokemon = pokemons[i - 1];
    pokemonMap.set(i, pokemon);
    pokemonReverseMap.set(pokemon, i);
  }

  for (let i = 0; i < problemCount; i++) {
    const problem = problems[i];
    const charCode = problem[0].charCodeAt();

    if (48 <= charCode && charCode <= 57) {
      result.push(pokemonMap.get(parseInt(problem)));
    } else {
      result.push(pokemonReverseMap.get(problem));
    }
  }
